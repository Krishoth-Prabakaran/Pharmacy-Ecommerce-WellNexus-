  ...
  factory PatientDashboardData.fromJson(Map<String, dynamic> json) {
    return PatientDashboardData(
      ...
      profile: json['profile'] != null
          ? PatientProfile.fromJson(json['profile'])
          : null,
...
class PatientService {
  ...
  // static const String baseUrl = 'http://10.0.2.2:5000/api/patients';
  // For iOS emulator:
  // static const String baseUrl = 'http://localhost:5000/api/patients';
  // For physical device (use your computer's IP):
  // static const String baseUrl = 'http://192.168.x.x:5000/api/patients';
